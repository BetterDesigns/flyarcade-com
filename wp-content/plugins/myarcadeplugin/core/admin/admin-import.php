...
function myarcade_import_games() {
  ...
  $selected_method = filter_input( INPUT_POST, 'importmethod', FILTER_SANITIZE_STRING, array( "options" => array( "default" => 'importhtml5') ) );
  ?>
          ...
          <tr>
            <td>
              <select size="1" name="importmethod" id="importmethod">
                <option value="importhtml5" <?php selected( "importhtml5", $selected_method ); ?>><?php _e("HTML5 game (.zip)", 'myarcadeplugin'); ?>&nbsp;</option>
                <option value="importswfdcr" <?php selected( "importswfdcr", $selected_method ); ?>><?php _e("Flash or DCR game (.swf, .dcr)", 'myarcadeplugin'); ?>&nbsp;</option>
                <option value="importibparcade" <?php selected( "importibparcade", $selected_method ); ?>><?php _e("IBPArcade game (.tar)", 'myarcadeplugin'); ?></option>
                <option value="importphpbb" <?php selected( "importphpbb", $selected_method ); ?>><?php _e("PHPBB game (.zip)", 'myarcadeplugin'); ?></option>
                <option value="importunity" <?php selected( "importunity", $selected_method ); ?>><?php _e("Unity3D game (.unity3d)", 'myarcadeplugin'); ?></option>
                <option value="importembedif" <?php selected( "importembedif", $selected_method ); ?>><?php _e("Embed / Iframe game", 'myarcadeplugin'); ?></option>
              </select>
              <br />
