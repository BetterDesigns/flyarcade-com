        ...
        <table class="optiontable" width="100%">
          ...
          <tr>
            <td>
              ...
              <img id="loadimghtml5" src="<?php echo $loading_image; ?>" style="display:none;" />
        ...
        <div class="block">
          <table class="optiontable" width="100%">
            ...
            <td>
              ...
              <img id="loadimgtar" src="<?php echo $loading_image; ?>" style="display:none;" />
        ...
        <div class="block">
          <table class="optiontable" width="100%">
            ...
            <td>
              ...
              <img id="loadimgzip" src="<?php echo $loading_image; ?>" style="display:none;" />
        ...
        <div class="block">
          <table class="optiontable" width="100%">
            ...
            <td>
              ...
              <img id="loadimgunity" src="<?php echo $loading_image; ?>" style="display:none;" />
