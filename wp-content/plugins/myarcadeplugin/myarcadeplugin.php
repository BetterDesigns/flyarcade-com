...
if ( ! class_exists( 'MyArcadePlugin' ) ) :
	...
	final class MyArcadePlugin {
		...
		public function init() {
			...
			// Start new session.
			if ( $this->is_request( 'frontend' ) ) {
				// Handle MyArcadeScoreBridge calls.
				$this->scorebridge_handle();
		...
		/**
		 * Handle score and achievements submissions by MyArcadeScoreBridge.
		 */
		private function scorebridge_handle() {
			$bridge = new MyArcade_ScoreBridge();
			$bridge->handle();
		}
		...
		public function distributors() {
			return apply_filters(
				...
				array(
					'fourj'            => '4J',
					'fourjrevshare'    => '4J (Revenue Share)',
