<?php
/*
* Widget - BrayGames Video Widget
*/ 

require_once(dirname(__FILE__) . "/settings.php");

//Video Sidebar Widget Class to extend WP_Widget class
class BrayGamesVideoWidget extends WP_Widget {

		//function to set up widget in admin
		function BrayGamesVideoWidget() {
		
				$widget_ops = array( 'classname' => 'videosidebar', 
				'description' => __('Displays a video from various video sharing networks.', 'videosidebar') );
				
				$control_ops = array( 'width' => 200, 'height' => 350, 'id_base' => 'videosidebar' );
				$this->WP_Widget( 'videosidebar', __('BrayGames ==> Video', 'videosidebar'), $widget_ops, $control_ops );
