...
if ( !class_exists('WP_Widget_MABP_braygames_scroller') ) {
  class WP_Widget_MABP_braygames_scroller extends WP_Widget {

    // Constructor
    function WP_Widget_MABP_braygames_scroller() {

      $widget_ops   = array('description' => 'Shows Games scroller on right/left side bar.');

      $this->WP_Widget('MABP_braygames_scroller', 'BrayGames ==> Scroller', $widget_ops);
    }
