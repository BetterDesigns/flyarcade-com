...
if ( !class_exists('WP_Widget_MABP_small_squares') ) {
  class WP_Widget_MABP_small_squares extends WP_Widget {

    function WP_Widget_MABP_small_squares() {
      $widget_ops = array('description' => 'Display up to six small square banners (125x125) in a grid view.');
      $this->WP_Widget('MABP_small_squares', 'BrayGames ==> Small Square Banners', $widget_ops);
